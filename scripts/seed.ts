...
const main = async () => {
  try {
    ...
    await db.insert(schema.lessons).values([
      ...
      { id: 5, unitId: 1, order: 5, title: "Nouns" },
    ]);
    ...
    await db.insert(schema.challengeOptions).values([
      {
        id: 1,
        challengeId: 1, // which one of these is answering to "the man"
        imageSrc: "/man.svg",
        correct: true,
        text: "el hombre",
        audioSrc: "/es_man.mp3",
    ...
    await db.insert(schema.challengeOptions).values([
      {
        id: 4,
        challengeId: 2, // which one of these is answering to "the man"
        correct: true,
        text: "el hombre",
        audioSrc: "/es_man.mp3",
      },
    ...
    await db.insert(schema.challengeOptions).values([
      {
        id: 7,
        challengeId: 3, // which one of these is answering to "the man"
        imageSrc: "/man.svg",
        correct: false,
        text: "el hombre",
        audioSrc: "/es_man.mp3",
